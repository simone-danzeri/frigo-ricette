        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow rounded-4 border-0">
                <div class="card-body p-5">
                    <h1 class="h3 mb-5 text-center fw-semibold">✏️ Modifica ricetta</h1>
                    ...
                    <form action="{{ route('recepies.update', $recepie->id) }}" method="POST" class="vstack gap-4">
                        @csrf
                        @method('PUT')

                        <div class="form-floating">
                            <input type="text" name="name" id="name" value="{{ old('name', $recepie->name) }}"
                                class="form-control rounded-3 @error('name') is-invalid @enderror" placeholder="Nome ricetta" required>
